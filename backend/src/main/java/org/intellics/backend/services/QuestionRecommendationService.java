...
public interface QuestionRecommendationService {
     ...
     */
    QuestionDto getNextQuestion(UUID userId, UUID lessonId, UUID moduleId, Boolean includePrerequisites);
     ...
     */
    QuestionWithScaffoldsDto getNextQuestionWithScaffolds(UUID userId, UUID lessonId, UUID moduleId, Boolean includePrerequisites);
     ...
     */
    List<QuestionRecommendationDto> getPracticeSession(UUID userId, UUID lessonId, UUID moduleId, int count, Boolean includePrerequisites);
}
