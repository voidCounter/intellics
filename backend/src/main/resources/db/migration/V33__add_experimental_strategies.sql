...
CREATE TABLE IF NOT EXISTS strategy_interaction_rules (
...
CREATE TABLE IF NOT EXISTS user_experimental_assignments (
...
CREATE INDEX IF NOT EXISTS idx_strategy_interaction_rules_strategy_id ON strategy_interaction_rules(strategy_id);
CREATE INDEX IF NOT EXISTS idx_user_experimental_assignments_strategy_id ON user_experimental_assignments(strategy_id);
CREATE INDEX IF NOT EXISTS idx_user_experimental_assignments_assigned_by ON user_experimental_assignments(assigned_by);
...
ON CONFLICT (strategy_id, interaction_type) DO NOTHING;
