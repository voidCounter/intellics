-- ============================================================
-- Migration: Fix timestamp type mismatch in recommend_questions function
-- Issue: Function returns TIMESTAMP but database column is TIMESTAMP WITH TIME ZONE
-- Solution: Update function to properly handle timestamptz conversion
-- ============================================================

-- Drop the existing function first
DROP FUNCTION IF EXISTS recommend_questions(UUID, TEXT, UUID, UUID, INTEGER, BOOLEAN, INTEGER, INTEGER);
